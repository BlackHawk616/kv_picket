...
export const Card: FC<CardProps> = ({ children, className, ...props }) => {
  const cardClass = classNames('border rounded shadow p-4', className);
...
export const CardContent: FC<HTMLAttributes<HTMLDivElement>> = ({ children, className, ...props }) => {
  const cardContentClass = classNames('p-4', className);
...
export const CardFooter: FC<HTMLAttributes<HTMLDivElement>> = ({ children, className, ...props }) => {
  const cardFooterClass = classNames('border-t p-4 mt-4', className);
