        ...
        <section id="curriculum" className="py-12">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              <Card>
                <CardContent>
                  <h3 className="text-xl font-bold mb-2">Electives</h3>
                  <p className="text-muted-foreground">Diverse range of elective courses.</p>
                </CardContent>
                <CardFooter>
                  <Link href="#" className="text-primary hover:underline" prefetch={false}>
                    Learn More
        ...
        <section id="sample-papers" className="bg-muted py-12">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              <Card>
                <CardContent>
                  <h3 className="text-xl font-bold mb-2">Entrance Exam Sample Papers</h3>
                  <p className="text-muted-foreground">Download sample papers for entrance exams.</p>
                </CardContent>
                <CardFooter>
                  <Link href="#" className="text-primary hover:underline" prefetch={false}>
                    Download
