...
const subjects = [
  { name: "Physics", href: "/notes/class11/physics" },
  { name: "Chemistry", href: "/notes/class11/chemistry" },
  { name: "Maths", href: "/notes/class11/maths" },
  { name: "Computer Science", href: "/notes/class11/cs" },
  { name: "Informatics Practices", href: "/notes/class11/ip" },
];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex flex-col justify-center items-center p-4">
        <h1 className="text-3xl font-bold mb-8">Class 11th Notes</h1>
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", width: "100%", maxWidth: "500px" }}>
          {subjects.map((subject) => (
            <Card key={subject.name} style={{ width: "100%", margin: "0 auto" }}>
              ...
              <CardFooter>
                <Link href={`/Notes/Class11th/${subject.name.toLowerCase().replace(/\s+/g, '')}`}>
